...
if (isset($_GET['type']) && $_GET['type'] == 'delete') {
    ...
    ?>
    <script>
        window.location.assign('<?php echo esc_url(admin_url('admin.php?page=purchase_list')); ?>')
    </script>
    <?php
}
                ...
                <div class="col-sm-4">
                    <form action="#" class="form-inline" method="POST">
                        <div class="form-group">
                            ...
                            <a href="" class="btn btn-primary" style="margin-left: 15px;">Individual
                                Edit</a>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="card-header" style="background-color:#563d7c">
                        <div class="row">
                            ...
                            <div class="col-md-3 offset-6 text-right">
                                <a href="<?php echo esc_url(admin_url('admin.php?page=purchase_add')); ?>"
                                ...
                                <?php foreach ($products as $i => $p) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo esc_url(admin_url('admin.php?page=purchase_list&type=delete&id=' . $p->invoice_id)); ?>"
